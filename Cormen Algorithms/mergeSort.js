...
function merge (firstArray, secondArray) {
  ...
  // While both input array is not empty
  while( !firstArray.isEmpty() && !secondArray.isEmpty() ){
  
    // Take the smallest elements of the 2 input array and compare them
    // Remove the smaller element and put it into the top of output array
